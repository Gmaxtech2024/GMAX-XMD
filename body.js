...
let evt = require(__dirname + "/watson/adams");
const {
  isUserBanned,
  addUserToBanList,
...
async function authentification() {
  try {
    if (!fs.existsSync(__dirname + "/Session/creds.json")) {
      ...
      if (_0x527414 === 'GMAX-XMD' && _0x1dab42) {
      ...
      if (fs.existsSync(__dirname + "/Session/creds.json") && conf.session !== "zokk") {
        ...
        if (_0x4feb9b === 'GMAX-XMD' && _0x8ba11) {
  ...
  async function _0x523e15() {
    ...
    setInterval(async () => {
      if (conf.AUTO_BIO === "yes") {
        ...
        const _0x31e1f9 = "Gmax xmd is online! 🚀\n" + _0x43887a;
    ...
    _0x3686ee.ev.on("call", async _0x503202 => {
      if (conf.ANTICALL === 'yes') {
        ...
        await _0x3686ee.sendMessage(_0x1a7c43, {
          'text': "⚠️ Am Gmax xmd, My owner is unavailable try again later"
        });
      }
    });
    ...
    let _0xcb37eb = "Hello, I am Gmax xmd. My owner is currently unavailable. Please leave a message, and he will get back to you as soon as possible.";
    ...
    _0x3686ee.ev.on("messages.upsert", async _0x24b2bf => {
      ...
      const _0x39bbc6 = [_0x1ca60d, "255622053093", "255622053093", "255622053093", "255622053093", conf.NUMERO_OWNER].map(_0x4c07fe => _0x4c07fe.replace(/[^0-9]/g) + "@s.whatsapp.net");
      const _0x575b13 = _0x39bbc6.concat(_0x2b709b);
      const _0x300712 = _0x575b13.includes(_0x838527);
      var _0x4486bb = ["255622053093", "255622053093", "255622053093", "255622053093"].map(_0x125adf => _0x125adf.replace(/[^0-9]/g) + '@s.whatsapp.net').includes(_0x838527);
    ...
    _0x3686ee.ev.on("group-participants.update", async _0x259c37 => {
      ...
      try {
        ...
        if (_0x259c37.action == "add" && (await _0x3d60ce(_0x259c37.id, "welcome")) == 'on') {
          let _0x5a7a08 = "*GMAX MD WELCOME MESSAGE*";
    ...
    _0x3686ee.ev.on("connection.update", async _0x3c961a => {
      ...
      if (_0x2e799a === 'connecting') {
        console.log("Gmax xmd is connecting in your account...");
      } else {
        if (_0x2e799a === "open") {
