// Leave this api.cxx.popkiddevs
// WACHANA NA CODE ZA BOT YANGU UNDA ZAKO 🤦
// SCRIPTED BY POPKID KE 254 ezra api.s
// THIS SCRIPT FOR POPKID MD ONLY
...
zokou({
  ...
  try {
    ...
    if (_0x3b69f5.status === 200 && _0x3b69f5.success) {
      ...
      _0x59580a("✅ Downloaded Successfully BY Gmax Xmd");
    } else {
...
zokou({
  ...
  try {
    ...
    if (_0x2c3cff.status === 200 && _0x2c3cff.success) {
      ...
      _0x3adfb5("✅ Downloaded Successfully By Gmax Xmd");
    } else {
...
zokou({
  ...
  try {
    ...
    if (_0x1c3b78.status === 200 && _0x1c3b78.success) {
      ...
      _0x3febab("✅ Downloaded Successfully by Gmax Xmd");
    } else {
...
zokou({
  ...
  try {
    ...
    if (_0x3b69f5.status === 200 && _0x3b69f5.success) {
      ...
      _0x59580a("✅ Downloaded Successfully BY Gmax Md");
    } else {
      _0x59580a("❌ Failed to download the video.");
    }
  } catch (_0x487250) {
...
zokou({
  ...
  try {
    ...
    if (_0x3b69f5.status === 200 && _0x3b69f5.success) {
      ...
      _0x59580a("✅ Downloaded Successfully BY popkid Md");
    } else {
      _0x59580a("❌ Failed to download the video.");
    }
  } catch (_0x487250) {
