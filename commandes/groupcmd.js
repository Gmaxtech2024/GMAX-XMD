...
const {
  ...
  let _0x3f6faa;
  try {
    _0x3f6faa = await _0x4375b2.profilePictureUrl(_0x24f18e, "image")["catch"]("https://files.catbox.moe/o973mw.jpeg");
  } catch (_0x6d1bf4) {
    _0x3f6faa = "https://files.catbox.moe/o973mw.jpeg";
  }
...
zokou({
  ...
  for (let _0x398282 of _0x115598) {
    let _0x25a35f = "‼️‼️GMAX XMD BROADCAST‼️️‼️\n\n❗*message* : " + _0x1360fc + "\n\n️‼️ *Author*: " + _0x271224;
    await _0x4cdb8c.sendMessage(_0x398282, {
      'image': {
        'url': "https://files.catbox.moe/o973mw.jpeg"
      },
      'caption': '' + _0x25a35f
    });
  }
...
zokou({
  ...
  _0x298913("All pending participants have been approved to join by gmax md.");
});
